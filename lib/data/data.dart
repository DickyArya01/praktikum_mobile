...
List<Wisata> listWisata = [
  Wisata(
      ...
      desc:
          'Gunung berapi ini adalah salah satu gunung yang terpopuler di Jawa Timur selain kawah gunung ijen. Bahkan Bromo adalah wisata alam pegunungan yang paling banyak di kunjungi wisatawan lokal dan asing sebagai tujuan liburan pribadi dan keluarga di Malang. Hal ini bisa di ketahui oleh program pemerintah yang gencar mempromosikan lokasi gunung bromo sebagai destinasi terbaik hingga hingga ke manca negara. Tidak mengherankan mengapa gunung bromo begitu difavoritkan oleh semua kalangan karena pesona dan tekstur dari gunung bromo adalah salah satu wisata alam gunung yang sangat langka dan memang tidak ada yang menyerupai dengan gunung gunung manapun di dunia ini.'),
  Wisata(
      namaWisata: 'Wakatobi',
      imgAssets:
